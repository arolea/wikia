...
import com.learning.wikia.rest.config.authentication.AccountCredentials;
...
public class JWTLoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain, Authentication auth) throws IOException, ServletException {
        res.setHeader("IS-ADMIN", ((WikiaUserDetails) auth.getPrincipal()).isAdmin().toString());
        TokenAuthenticationService.addAuthentication(res,(WikiaUserDetails) auth.getPrincipal());
    }
}
